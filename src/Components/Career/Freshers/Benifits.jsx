            ...
            <div className="space-y-3">
              <div className="md:flex gap-8">
                ...
                <div>
                  ...
                  <div className="text-sm md:text-lg p-2 text-gray-400" style={{ color: mode === "dark" ? "text-gray-400" : "black" }}>
                    BDM offers up to{" "}
              ...
              <div className="md:flex gap-8">
                ...
                <div>
                  ...
                  <div className="md:text-lg text-sm p-2 text-gray-400" style={{ color: mode === "dark" ? "text-gray-400" : "black" }}>
              ...
              <div className="md:flex gap-8">
                ...
                <div>
                  ...
                  <div className="md:text-lg md:sm p-2 text-gray-400" style={{ color: mode === "dark" ? "text-gray-400" : "black" }}>
            ...
            <div className="md:px-32 py-10">
              <div className="md:flex w-full">
                <div>
                  ...
                  <div className="md:text-lg text-sm pt-8 md:pr-20 text-gray-400" style={{ color: mode === "dark" ? "text-gray-400" : "black" }}>
            ...
            <div className="md:px-32 py-4 md:py-10">
              <div className="md:flex w-full">
                <div>
                  ...
                  <div className="md:text-lg pb-4 text-sm md:pt-8 md:pr-20 text-gray-400" style={{ color: mode === "dark" ? "text-gray-400" : "black" }}>
              ...
              <div>
                <div className="font-semibold tracking-wider text-xl md:text-2xl py-5 dark:text-[#FC4A1A]">We believe in you</div>
                <div className="md:text-lg text-sm text-gray-400" style={{ color: mode === "dark" ? "text-gray-400" : "black" }}>
