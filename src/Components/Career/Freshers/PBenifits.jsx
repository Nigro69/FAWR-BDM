    ...
    <Layout>
      <div className="p-4 md:mx-10 my-4">
        ...
        <div className="tracking-wide text-lg text-gray-400 md:px-10 text-center">
          ...
          experience you deliver as well as the relationship you develop with
          your customers, partners, and shareholders.An organisation's values
          lay the foundation for what the company cares about most. It provides
          a common purpose that all employees should understand, work towards
          and live by. Once you define and promote your values, employees come
          to understand the behaviours that are expected of them that will lead
          to success.To learn about your values, think back to the best and most
          painful moments in your life. Consider what these experiences reveal
          about your core values. For example, if you won an award for teaching,
          it's possible that motivating others and leadership are important
          values for you.
        </div>
