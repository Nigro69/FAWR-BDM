    ...
    <Layout>
      <div className="p-4 md:mx-10 md:my-4">
        <div className="md:flex gap-20 w-full my-10">
          <div className="md:w-2/4 w-full my-auto">
            ...
            <div className="tracking-wide text-sm md:text-lg text-gray-400">
              ...
              sustaining a diverse work environment and workforce, which is
              critical to meeting the unique needs of our diverse client base
              and the communities in which we operate. We are committed to
              making progress toward{" "}
              <label className="text-[#BC312E]"> racial equity</label>,
              advancing{" "}
              <label className="text-[#BC312E]"> gender equality</label>, and
              increasing representation at every level of our firm.
            </div>
          </div>
        ...
        <div className="flex place-items-center my-5 gap-10 w-full">
          <div className="font-semibold text-[#BC312E] text-2xl tracking-wide w-2/4 md:w-1/6">
            Read About
          </div>
        ...
        <div className="grid md:grid-cols-4 my-8 gap-5">
          <div className="relative">
            <img src={f9} alt="ic-img" />
            <div className="absolute bottom-10 w-3/4 h-20  rounded-lg bg-black grid place-items-center text-center left-10 bg-opacity-80 text-xl font-sans text-[#BC312E]">
              Fostering Inclusion & Inclusion networks
            </div>
          </div>
          <div className="relative">
            <img src={f10} alt="ic-img" />
            <div className="absolute bottom-10 w-3/4 h-20  rounded-lg bg-black grid place-items-center text-center left-10 bg-opacity-80 text-xl font-sans text-[#BC312E]">
              Diversity Award
            </div>
          </div>
          <div className="relative">
            <img src={f11} alt="ic-img" />
            <div className="absolute bottom-10 w-3/4 h-20  rounded-lg bg-black grid place-items-center text-center left-10 bg-opacity-80 text-xl font-sans text-[#BC312E]">
              Gender Pay Gap Report
            </div>
          </div>
          <div className="relative">
            <img src={f12} alt="ic-img" />
            <div className="absolute bottom-10 w-3/4 h-20  rounded-lg bg-black grid place-items-center text-center left-10 bg-opacity-80 text-xl font-sans text-[#BC312E]">
