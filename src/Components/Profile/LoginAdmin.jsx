        ...
        <div className='grid place-items-center' style={myStyle}>
          <div className='flex gap-40'>
            <div className='h-96 w-80 p-8 transition-all ease-in-out hover:scale-105 duration-500 delay-75 rounded-lg dark:bg-[#211F22] rnd-shd'>
              <img className='h-48 w-full object-cover' src={c3} alt="kkadsas" />
              <div className='font-semibold text-xl text-gray-200 tracking-widest text-center py-6 font-sans'>HRM</div>
            ...
            <div className='h-96 w-80 p-8 transition-all ease-in-out hover:scale-105 duration-500 delay-75 rounded-lg dark:bg-[#211F22] rnd-shd'>
              <img className='h-48 w-full object-cover' src={c4} alt="kkadsas" />
              <div className='font-semibold text-xl text-gray-200 tracking-widest text-center py-6 font-sans'>CMS</div>
              <div className='grid place-items-center'>
