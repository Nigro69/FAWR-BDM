...
>>>>>>> 27712c2db85eb8c9560d1840ec6aaa9a2a7a7c0b
  ...
  return (
    <div className="reach-outer">
      ...
      <div className="reach-right">
        <div
          className="reach-box"
          style={{ backgroundColor: mode === "dark" ? "#211F22" : "white" }}
        >
          <Stack direction="column" spacing={10}>
            <Input
              borderColor="#211F22"
              backgroundColor={mode === "dark" ? "#2B292C" : "#E0E0E0"}
              ...
              _placeholder={{
                ...
                fontSize: isLargerThan900 ? "1rem" : "0.8rem",
              }}
              placeholder="Name"
            />
